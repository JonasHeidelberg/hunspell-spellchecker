...
// Reviver to handle RegExp deserialization
var regexpReviver = function(key, value) {
...
Dictionary.prototype.load = function (obj) {
    // Handle both pre-revived objects and raw JSON strings
    if (typeof obj === 'string') {
        obj = JSON.parse(obj, regexpReviver);
    } else {
        // If it's already an object, we need to revive RegExp objects recursively
        obj = JSON.parse(JSON.stringify(obj), regexpReviver);
    }
